...
if (isset($_POST["submit"])) {
  ...
  if ($result) {
    header("Location: index.php?msg=แก้ไขเสร็จสิ้น");
  } else {
...
<body>
  ...
  <div class="container">
    <div class="text-center mb-4">
      <h3>แก้ไขรายงานการวิเคราะห์พื้นที่</h3>
...
<div class="container d-flex justify-content-center">
         ...
         <div class="mb-3">
            ...
            <div class="mb-3">
               ...
               <input type="text" class="form-control" name="weakness" value="<?php echo $row['weakness'] ?>">
            </div>
            <div class="mb-3">
               <label class="form-label">โอกาสและความท้าทายในพื้นที่:</label>
               <input type="text" class="form-control" name="opportunity" value="<?php echo $row['opportunity'] ?>">
            </div>
            <div class="mb-3">
               <label class="form-label">อุปสรรคและปัจจัยคุกคามในพื้นที่:</label>
               <input type="text" class="form-control" name="threats" value="<?php echo $row['threats'] ?>">
            </div>
            ...
            <li class="mb-3">
               ...
               <input type="text" class="form-control" name="landmarks" value="<?php echo $row['landmarks'] ?>">
            </li>
            <li class="mb-3">
               <label class="form-label">พืชเศรษฐกิจในพื้นที่:</label>
               <input type="text" class="form-control" name="plant" value="<?php echo $row['plant'] ?>">
            </li>
            <li class="mb-3">
               <label class="form-label">สิ่งที่มีมากในพื้นที่:</label>
               <input type="text" class="form-control" name="thing" value="<?php echo $row['thing'] ?>">
            </li>
            <li class="mb-3">
               <label class="form-label">กลุ่มชุมชน/วิสาหกิจชุมชน:</label>
               <input type="text" class="form-control" name="community" value="<?php echo $row['community'] ?>">
            </li>
            <div class="row mb-3">
               <div class="col">
